...
| filt2                            | Easily perform 2D highpass, lowpass, bandpass, or bandstop filters on gridded datasets | [click](https://de.mathworks.com/matlabcentral/fileexchange/61003-filt2-2d-geospatial-data-filter) | 1.1.0.0  | January 5, 2017   | -                                                         |
...
| interpns                         | N-dimensional simplicial interpolation                       | [click](https://de.mathworks.com/matlabcentral/fileexchange/30932-interpns) | 1.0.0.0  | March 31, 2011     | -                                                         |
| lininterp                        | Much faster version of the interp functions, but ONLY for LINEAR interpolation | [click](https://de.mathworks.com/matlabcentral/fileexchange/28376-faster-linear-interpolation) | 1.3.0.0  | August 4, 2010     | -                                                         |
| matlab_scatteredInterpn          | Linear interpolation of n-dimensional scattered data | [click](https://de.mathworks.com/matlabcentral/fileexchange/54874-scatteredinterpn) | -        | -                  | submodule |
...
| phdiffmeasure                    | Phase difference measurement between two signals via DFT     | [click](https://de.mathworks.com/matlabcentral/fileexchange/48025-phase-difference-measurement-with-matlab-implementation) | 1.3.0.0  | April 10, 2016        | -                                                         |                         |
...
| bplot                    | Creates nice boxplots from data. You don't need a toolbox. Simple yet fully featured. | [click](https://de.mathworks.com/matlabcentral/fileexchange/42470-box-and-whiskers-plot-without-statistics-toolbox) | 1.0.0.0  | September 16, 2015       | -                                             |
| BrewerMap                | The complete palette of ColorBrewer colormaps                | [click](https://github.com/DrosteEffect/BrewerMap)           | -        | -                  | submodule                                     |
| C2xyz                    | Convert values given by a contour matrix to easy-to-use cells | [click](https://de.mathworks.com/matlabcentral/fileexchange/43162-c2xyz-contour-matrix-to-coordinates) | 1.2.1    | May 20, 2019       | -                                             |
...
| ndhist                   | Creates 2D histogram of scatterplot or lineseries data, really fast, fully featured | [click](https://de.mathworks.com/matlabcentral/fileexchange/45325-efficient-2d-histogram-no-toolboxes-needed) | 1.5.0.0  | September 16, 2015 | -                                             |
| nhist                    | Compares multiple sets of data elegantly. Set bins and axis bounds to be appropriate for the data. | [click](https://de.mathworks.com/matlabcentral/fileexchange/27388-plot-and-compare-histograms-pretty-by-default) | 1.13.0.0  | September 16, 2015 | -                                             |
...
| radarplot                | Create a radar plot                                          | [click](https://de.mathworks.com/matlabcentral/fileexchange/33134-radar-plot) | 1.0.0.0  | October 5, 2011 | -                                             |
...
| sanePColor               | Wrapper for pcolor that behaves similarly to imagesc. Squash OS X Preview's "blurry image" bug | [click](https://de.mathworks.com/matlabcentral/fileexchange/35601-sanepcolor-varargin) | 1.2.0.0  | October 6, 2016  | -                                             |
