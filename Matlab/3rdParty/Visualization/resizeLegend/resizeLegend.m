...
set(HLegBack,'Box','on', 'GridColor','none', 'Units','normalized', ...
	'Position',Size, 'Tag','LegendBackground', 'Visible','off', ...
	'XColor',HLeg.EdgeColor,'YColor',HLeg.EdgeColor,'ZColor',HLeg.EdgeColor);
grid(HLegBack,'off');
...
Size = [min([HLeg.UserData.HLines.XData ...
                 HLeg.UserData.HMarkers.XData]) ... %Min of lines & markers 
