...
% if light <= 30
%     p_EW = plot(-40, 25, 'o','MarkerEdgeColor','red',...
%         'MarkerFaceColor','red',...
%         'MarkerSize',3);
%     p_NS = plot(-25, 40, 'o','MarkerEdgeColor','green',...
%         'MarkerFaceColor','green',...
%         'MarkerSize',3);
% else
%     p_EW = plot(-40, 25, 'o','MarkerEdgeColor','green',...
%         'MarkerFaceColor','green',...
%         'MarkerSize',3);
%     p_NS =  plot(-25, 40, 'o','MarkerEdgeColor','red',...
%         'MarkerFaceColor','red',...
%         'MarkerSize',3);
% end
t_val = num2str(0);
